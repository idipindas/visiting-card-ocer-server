...
mongoose
  .connect(
    "mongodb+srv://dipindasofficial:aB7gxz2F1zPG40zM@cluster0.xk3ll.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    {
...
app.post("/api/saveCardData", upload.single("image"), async (req, res) => {
  ...
  try {
    ...
    res
      .status(201)
      .json({ message: "Card data saved successfully", card: newCard });
  } catch (error) {
